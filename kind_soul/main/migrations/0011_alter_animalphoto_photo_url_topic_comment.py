...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0010_remove_animalphoto_photo_animalphoto_photo_url'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='main.topic')),
            ],
        ),
    ]
